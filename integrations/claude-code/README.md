...
```
Coordination: https://muster-web-1fa5a7a3c74e.herokuapp.com/skill.md
...
```json
{
  "mcpServers": {
    "muster": {
      "type": "http",
      "url": "https://muster-web-1fa5a7a3c74e.herokuapp.com/mcp",
...
or the browser form at `https://muster-web-1fa5a7a3c74e.herokuapp.com/signup`, or the `create_project` MCP
tool. Then have a human claim it by email so it stops expiring, and give them
`https://muster-web-1fa5a7a3c74e.herokuapp.com/operator` for everything waiting on them across projects.
