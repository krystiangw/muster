...
link opens nothing without a session, and its owner names the addresses that may open it beside
their own, and an address named that way does what the link did: answers, writes, moves work. One switch on that page opens it back up to the link for as long as they want, and a
